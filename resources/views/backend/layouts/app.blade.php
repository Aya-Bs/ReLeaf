            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        @if(auth()->user() && auth()->user()->role === 'auteur')
                            <li class="nav-header">AUTEUR</li>
                            <li class="nav-item">
                                <a href="{{ route('auteur.dashboard') }}" class="nav-link {{ request()->routeIs('auteur.dashboard') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-user-edit"></i>
                                    <p>Dashboard Auteur</p>
                                </a>
                            </li>
                            <li class="nav-item has-treeview {{ request()->routeIs('auteur.blogs.*') ? 'menu-open' : '' }}">
                                <a href="#" class="nav-link {{ request()->routeIs('auteur.blogs.*') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('auteur.blogs.create') }}" class="nav-link {{ request()->routeIs('auteur.blogs.create') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Créer Blog</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('auteur.blogs.index') }}" class="nav-link {{ request()->routeIs('auteur.blogs.index') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Voir Blogs</p>
                                        </a>
                                    </li>
