...
@section('title', 'Dons de l\'événement - ' . $event->title)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    @if($donation->status === 'pending' && Auth::user()->isAdmin())
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    <p>Aucun don pour cet événement</p>
                                    <a href="{{ route('donations.create', $event) }}" class="btn btn-success">
                                        <i class="fas fa-plus me-2"></i>Encourager les dons
                                    </a>
                                </div>
                            </td>
                        </tr>
