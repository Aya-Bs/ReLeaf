                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <select class="form-select @error('sponsorship_type') is-invalid @enderror" 
                                            id="sponsorship_type" name="sponsorship_type" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('motivation') is-invalid @enderror" 
                                              ...
                                              placeholder="Expliquez votre motivation pour soutenir nos événements écologiques..." required>{{ old('motivation') }}</textarea>
