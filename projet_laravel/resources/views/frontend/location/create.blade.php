        ...
        <div class="col-12">
            <div>
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">
                        <i class="fas fa-home me-2" style="color: #2d5a27;"></i><strong>Créer un nouveau lieu</strong>
                    </h4>
                    <!-- Breadcrumb -->
                                ...
                                <form action="{{ route('locations.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 shadow rounded-5 border-0 h-100">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="in_repair" name="in_repair" value="1" {{ old('in_repair') ? 'checked' : '' }}>
