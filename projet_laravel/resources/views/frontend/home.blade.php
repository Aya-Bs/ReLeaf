...
<section class="top-sponsors-section py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-4">
                <h2 class="section-title"><span class="text-success">Sponsors à l'honneur</span></h2>
                <p class="text-muted">Nous remercions nos partenaires pour leur contribution déterminante</p>
            </div>
        </div>
        ...
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card sponsor-card h-100 shadow-sm border-0 text-center p-3">
                    <div class="mb-2">
                        @if(!empty($s->logo_url))
                        <img class="rounded-circle" style="width:64px;height:64px;object-fit:cover;" src="{{ $s->logo_url }}" alt="{{ $s->company_name ?? 'Sponsor' }}">
                        @else
                        <div class="d-inline-flex align-items-center justify-content-center bg-white border" style="width:64px;height:64px;border-radius:50%;">
                    ...
                    <div class="mt-2">
                        ...
                        @else
                        <span class="badge bg-success-subtle text-success border border-success">{{ $primaryBadge['label'] }}</span>
                        @endif
                    </div>
                    @endif
                </div>
        ...
        @else
        <div class="alert alert-light border text-center">Aucun sponsor affiché pour le moment.</div>
        @endif
    </div>
</section>
@endsection
...
<style>
    ...
    .hero-carousel-image {
        height: 420px;
        /* Fixed header image height (reduced for consistent header) */
        width: 100%;
