            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <style>
                            .tag-color-a{background-color:#2d5a27;color:#fff;}
                            .tag-color-b{background-color:#4a7c59;color:#fff;}
                            .tag-color-c{background-color:#8bc34a;color:#fff;}
                            .tag-color-d{background-color:#1b3a17;color:#fff;}
                            .tag-color-e{background-color:#5c7cfa;color:#fff;}
                            .tag-color-f{background-color:#f59f00;color:#fff;}
                            .tag-color-g{background-color:#d6336c;color:#fff;}
                        </style>
